...
const BookingEntryEmployeeList = () => {
    const [employee, setEmployee] = useState([]);
    const { id } = useParams();
    const init = () => {
        EmployeeService.getBookingEntryEmployee(id)
            .then(response => {
    ...
    return (
        <div className="container">
            ...
            <hr />
            <div>
                <Link to={`/bookingEntry/${id}/employee`} className="btn btn-primary mb-2">Add Employee</Link>
...
export default BookingEntryEmployeeList;